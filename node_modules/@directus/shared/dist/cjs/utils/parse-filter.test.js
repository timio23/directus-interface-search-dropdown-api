...
const parse_filter_1 = require("./parse-filter");
describe('', () => {
    beforeEach(() => {
        jest.useFakeTimers();
    ...
    it('returns the filter when passed accountability with only a role', () => {
        ...
        expect((0, parse_filter_1.parseFilter)(mockFilter, mockAccountability)).toStrictEqual(mockFilter);
    });
    it('returns the filter includes an _in it parses the filter with a deepMap', () => {
        ...
        const mockAccountability = { role: 'admin' };
        expect((0, parse_filter_1.parseFilter)(mockFilter, mockAccountability)).toStrictEqual(mockResult);
    });
    it('returns the filter includes an _in it parses the filter with a deepMap', () => {
        const mockFilter = {
            _and: [
