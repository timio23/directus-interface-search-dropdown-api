...
exports.generateJoi = exports.Joi = void 0;
const joi_1 = __importDefault(require("joi"));
const lodash_1 = require("lodash");
exports.Joi = joi_1.default.extend({
    type: 'string',
...
function generateJoi(filter, options) {
    var _a, _b;
    filter = filter || {};
    options = (0, lodash_1.merge)({}, defaults, options);
    const schema = {};
    ...
    if (((_a = Object.keys(value)[0]) === null || _a === void 0 ? void 0 : _a.startsWith('_')) === false) {
        ...
        const getAnySchema = () => { var _a; return (_a = schema[key]) !== null && _a !== void 0 ? _a : exports.Joi.any(); };
        const getStringSchema = () => { var _a; return ((_a = schema[key]) !== null && _a !== void 0 ? _a : exports.Joi.string()); };
        const getNumberSchema = () => { var _a; return ((_a = schema[key]) !== null && _a !== void 0 ? _a : exports.Joi.number()); };
        const getDateSchema = () => { var _a; return ((_a = schema[key]) !== null && _a !== void 0 ? _a : exports.Joi.date()); };
        if (operator === '_eq') {
        ...
        if (operator === '_starts_with') {
            schema[key] = getStringSchema().pattern(new RegExp(`^${(0, lodash_1.escapeRegExp)(compareValue)}.*`), {
                name: 'starts_with',
            });
        }
    ...
    schema[key] = (_b = schema[key]) !== null && _b !== void 0 ? _b : exports.Joi.any();
    if (options.requireAll) {
        schema[key] = schema[key].required();
    }
    return exports.Joi.object(schema).unknown();
}
exports.generateJoi = generateJoi;
